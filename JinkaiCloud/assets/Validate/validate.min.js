                ...
                c.ajax(c.extend(true, {
                    ...
                    success: function (result) {
                        if (result.status == 200) {
                            var h = result.data == false ? true : false;
                    ...
                    beforeSend: function (XMLHttpRequest) {
                        ...
                        //XMLHttpRequest.setRequestHeader("Authorize", jnpf.getAuthorize());
                    },
                },
                    d));
                return "pending"
...
$(function () {
    ...
    // 判断数值类型，包括整数和浮点数
    jQuery.validator.addMethod("isNumerical", function (value, element) {
    ...
    // 匹配密码，以字母开头，包含字母、数字和_-.#&,长度在6-16之间
    ...
    // 字符验证，只能包含中文、英文、数字、下划线等字符。    
    jQuery.validator.addMethod("chineseEnglishCheck", function (value, element) {
    ...
    //十六进制颜色正则
    jQuery.validator.addMethod("isRGB", function (value, element) {
    ...
    jQuery.validator.addMethod("isWechat", function (value, element) {
        return this.optional(element) || /^[a-zA-Z]([-_a-zA-Z0-9]{6,19})+$/.test(value);
    ...
    /**
    *  liuxiaoyang   20210108    
    */
    // 匹配编号，只能由数字、字母、-或_等字符组成
    jQuery.validator.addMethod("isNumber", function (value, element) {
        return this.optional(element) || /^[a-zA-Z0-9\-_]*$/.test(value);
    }, "编号只能由数字、字母、-或_等字符组成");
    // 匹配资产编号，只能由数字、字母、-或_等字符组成，长度3-30
    jQuery.validator.addMethod("isAssetsNumber", function (value, element) {
        return this.optional(element) || /^[a-zA-Z0-9\-_]{3,30}$/.test(value);
    }, "资产编号只能由数字、字母、-或_等字符组成。长度3-30");
});