...
(function (jQuery) {
    ...
    var Chart = function (div, opts) {
        ...
        function addHzHeader(div, dates, cellWidth) {
                ...
                for (var m in dates[y]) {
                    ...
                    for (var d in dates[y][m]) {
                        ...
                        if (DateUtils.isWeekend(dates[y][m][d])) {
                            weeksDiv.append(jQuery("<div>", { "class": "ganttview-hzheader-week weekend" }).append(weekNames[dates[y][m][d].getDay()]));
                        } else {
                            weeksDiv.append(jQuery("<div>", { "class": "ganttview-hzheader-week" }).append(weekNames[dates[y][m][d].getDay()]));
                        }
                    }
                }
            }
            ...
            headerDiv.append(monthsDiv).append(daysDiv).append(weeksDiv);
            div.append(headerDiv);
        }
        ...
        function addGrid(div, data, dates, cellWidth, showWeekends) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    rowDiv.attr("data-id", data[i].series[j].id);
                ...
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    var block = jQuery("<div>", {
                        ...
                        "css": {
                            ...
                            "margin-left": ((offset * cellWidth) + 5) + "px"
                        }
                    });
                    ...
                    jQuery(rows[rowIdx]).attr("data-id", id);
