...
$(function () {
    $('#hanzi').on('focusout', function (event) {
        event.preventDefault();
        var value = $(this).val();
        $(this).parents('#txttest').find('#spell').val(getPinYinByName(value));
    }).enter(function () {
        var value = $(this).val();
        $(this).focus();
        $(this).parents('#txttest').find('#spell').val(getPinYinByName(value));
        ...
        if (!$(this).val() == '') {
            $(this).val('');
            $(this).parents('#txttest').find('#spell').val('');
        }
    });
    //$('.xv_submit').on('click',function(event) {
    //	event.preventDefault();
    //       var name = $(this).parents('.list').find('#hanzi').val();
    //       var pinyin = $(this).parents('.list').find('#spell').val();
    //	if(name==''){
